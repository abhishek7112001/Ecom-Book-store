...
const ViewBookDetails = () => {
  ...
  const handleFavourite = async()=>{
    const response = await axios.put(`${import.meta.env.VITE_BASE_URL}/add-book-to-favourite` ,{},{headers});
  ...
  const handleCart = async()=>{
    const response = await axios.put(`${import.meta.env.VITE_BASE_URL}/add-to-cart`,{},{headers});
    alert(response.data.message);
  }

  const deleteBook = async()=>{
    const response = await axios.delete(`${import.meta.env.VITE_BASE_URL}/delete-book/`,{headers});
    alert(response.data.message);
    navigate('/all-books');
  }
  return (
